  ...
  const opensourceProjects = [
    {
      ...
      url: "https://github.com/mate-dev/mate-frontend",
    },
    {
      name: "mate-backend",
      ...
      url: "https://github.com/mate-dev/mate-backend",
    },
    {
      name: "mate-design-system",
      description: "MATE 서비스의 공용 디자인 시스템 컴포넌트",
      language: "TypeScript",
      stars: 28,
      license: "MIT",
      lastUpdated: "2024-03-20",
      url: "https://github.com/mate-dev/mate-design-system",
    },
  ];
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center space-x-3">
                    <span className="typo-caption2 flex items-center">
                      ⭐ {project.stars}
                    </span>
                ...
                <div className="typo-caption2 text-textDim mt-2">
